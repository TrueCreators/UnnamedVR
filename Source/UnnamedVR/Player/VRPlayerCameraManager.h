...
#include "VRPlayerCameraManager.generated.h"
...
class UNNAMEDVR_API AVRPlayerCameraManager : public APlayerCameraManager
{
	GENERATED_BODY()

public:
	AVRPlayerCameraManager();

	UFUNCTION(BlueprintCallable, Category = "ALS|Camera")
	void OnPossess(AVRPlayer* NewCharacter);
...
public:
	...
	AVRPlayer* ControlledCharacter = nullptr;
