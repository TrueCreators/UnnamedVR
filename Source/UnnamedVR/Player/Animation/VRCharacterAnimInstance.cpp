...
#include "UnnamedVR/Player/VRPlayer.h"
...
void UVRCharacterAnimInstance::NativeInitializeAnimation()
{
	...
	Character = Cast<AVRPlayer>(TryGetPawnOwner());
}
...
void UVRCharacterAnimInstance::PlayTransition(const FALSDynamicMontageParams& Parameters)
{
...
void UVRCharacterAnimInstance::PlayTransitionChecked(const FALSDynamicMontageParams& Parameters)
{
...
void UVRCharacterAnimInstance::PlayDynamicTransition(float ReTriggerDelay, FALSDynamicMontageParams Parameters)
{
...
bool UVRCharacterAnimInstance::CanDynamicTransition() const
{
	return GetCurveValue(NAME_Enable_Transition) >= 0.99f;
}

void UVRCharacterAnimInstance::PlayDynamicTransitionDelay()
{
	bCanPlayDynamicTransition = true;
}

void UVRCharacterAnimInstance::OnJumpedDelay()
{
	InAir.bJumped = false;
}

void UVRCharacterAnimInstance::OnPivotDelay()
{
	Grounded.bPivot = false;
}

void UVRCharacterAnimInstance::UpdateAimingValues(float DeltaSeconds)
{
...
void UVRCharacterAnimInstance::UpdateLayerValues()
{
...
void UVRCharacterAnimInstance::UpdateFootIK(float DeltaSeconds)
{
...
void UVRCharacterAnimInstance::SetFootLocking(float DeltaSeconds, FName EnableFootIKCurve, FName FootLockCurve,
...
void UVRCharacterAnimInstance::SetFootLockOffsets(float DeltaSeconds, FVector& LocalLoc, FRotator& LocalRot)
{
...
void UVRCharacterAnimInstance::SetPelvisIKOffset(float DeltaSeconds, FVector FootOffsetLTarget,
...
void UVRCharacterAnimInstance::ResetIKOffsets(float DeltaSeconds)
{
...
void UVRCharacterAnimInstance::SetFootOffsets(float DeltaSeconds, FName EnableFootIKCurve, FName IKFootBone,
...
void UVRCharacterAnimInstance::RotateInPlaceCheck()
{
...
void UVRCharacterAnimInstance::TurnInPlaceCheck(float DeltaSeconds)
{
...
void UVRCharacterAnimInstance::DynamicTransitionCheck()
{
...
void UVRCharacterAnimInstance::UpdateMovementValues(float DeltaSeconds)
{
...
void UVRCharacterAnimInstance::UpdateRotationValues()
{
...
void UVRCharacterAnimInstance::UpdateInAirValues(float DeltaSeconds)
{
...
void UVRCharacterAnimInstance::UpdateRagdollValues()
{
...
float UVRCharacterAnimInstance::GetAnimCurveClamped(const FName& Name, float Bias, float ClampMin,
                                                     float ClampMax) const
{
	return FMath::Clamp(GetCurveValue(Name) + Bias, ClampMin, ClampMax);
}

FALSVelocityBlend UVRCharacterAnimInstance::CalculateVelocityBlend() const
{
...
FVector UVRCharacterAnimInstance::CalculateRelativeAccelerationAmount() const
{
...
float UVRCharacterAnimInstance::CalculateStrideBlend() const
{
...
float UVRCharacterAnimInstance::CalculateWalkRunBlend() const
{
...
float UVRCharacterAnimInstance::CalculateStandingPlayRate() const
{
...
float UVRCharacterAnimInstance::CalculateDiagonalScaleAmount() const
{
...
float UVRCharacterAnimInstance::CalculateCrouchingPlayRate() const
{
...
float UVRCharacterAnimInstance::CalculateLandPrediction() const
{
...
FALSLeanAmount UVRCharacterAnimInstance::CalculateAirLeanAmount() const
{
...
EALSMovementDirection UVRCharacterAnimInstance::CalculateMovementDirection() const
{
...
void UVRCharacterAnimInstance::TurnInPlace(FRotator TargetRotation, float PlayRateScale, float StartTime,
...
void UVRCharacterAnimInstance::OnJumped()
{
	InAir.bJumped = true;
	...
	World->GetTimerManager().SetTimer(OnJumpedTimer, this,
	                                  &UVRCharacterAnimInstance::OnJumpedDelay, 0.1f, false);
}

void UVRCharacterAnimInstance::OnPivot()
{
	Grounded.bPivot = CharacterInformation.Speed < Config.TriggerPivotSpeedLimit;
	UWorld* World = GetWorld();
	check(World);
	World->GetTimerManager().SetTimer(OnPivotTimer, this,
	                                  &UVRCharacterAnimInstance::OnPivotDelay, 0.1f, false);
}
